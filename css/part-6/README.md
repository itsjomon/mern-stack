...
**General Example:** <br> <img src="grid/grid-general-example.png" alt="Grid General Example Image" width="400px">

**Grid Model:** <br> <img src="grid/grid-model.png" alt="Grid Model Diagram" width="600px">
...
@media (min-width: 200px) and (max-width: 400px) { /* Applies styles when viewport width is BETWEEN 200px and 400px */
    h1 {
